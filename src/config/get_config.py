...
def parse():
    ...
    '''
    additional_parse = argparse.ArgumentParser()
    additional_parse.add_argument('--args', nargs='+', type=str)
    cfg_additional = additional_parse.parse_known_args()[0]
    if cfg_additional.args is not None:
        default_parse.extend(cfg_additional.args)
    '''
